      ...
      <nav className='lg:h-[80px]'>
        <Container>
          <Flex className="justify-between lg:h-[80px] items-center">
            ...
            <div className="w-2/3">
              <ul className={`lg:flex lg:flex-row flex flex-col gap-y-3 gap-x-10 items-center font-sans text-[#767676] text-[18px] font-medium font-normal lg:static fixed duration-[800ms] ${show == true ? "bg-[#262626] top-[20px] left-0 w-full text-center py-2" : "top-[20px] left-[-100px]"}`}>
